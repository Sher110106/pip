/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4bcb5556e13f9911f3e46a41147f44a4)
// Runtime types generated with workerd@1.20250508.0 2025-02-11 nodejs_compat,nodejs_compat_populate_process_env
declare namespace Cloudflare {
	interface Env {
		...
		DependencyResolverAgent: DurableObjectNamespace<import("./src/server").DependencyResolverAgent>;
		PackageResearchAgent: DurableObjectNamespace<import("./src/server").PackageResearchAgent>;
		ReportGeneratorAgent: DurableObjectNamespace<import("./src/server").ReportGeneratorAgent>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "LOG_LEVEL" | "OPENAI_API_KEY" | "AZURE_OPENAI_API_KEY" | "AZURE_OPENAI_RESOURCE_NAME" | "AZURE_OPENAI_DEPLOYMENT_NAME" | "AZURE_OPENAI_API_VERSION">> {}
}
